...
class View
{
   ...
   public function getMeta()
   {
      ...
      $output .= '<link type="text/css" rel="stylesheet" href="/public/css/' . $this->layout . '.css" />' . PHP_EOL;
      $output .= '<link type="text/css" rel="stylesheet" href="/public/css/' . $this->view  . '.css" />' . PHP_EOL;
      return $output;
   }
